...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Top banner - LOVE YOU */}
      <div className="w-full h-12 bg-pink-100 flex items-center justify-center text-xl font-bold tracking-wide text-pink-400">
      ...
      <header className="w-full flex items-center justify-between px-6 bg-white shadow-sm h-24">
        <div className="font-bold text-xl text-pink-600 flex items-center gap-1">
          <img src="/logo-placeholder.png" alt="Gifting" className="h-10 w-10" />
          <span>Gifting</span>
        </div>
        ...
        <nav className="flex gap-6 items-center">
          ...
          <div className="relative">
            <button
              ...
              style={{ minWidth: 0 }}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-2 flex-shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="#" className="flex items-center text-gray-700 relative">
            ...
            <div
              ...
              onMouseLeave={() => {
                ...
                setTimeout(() => {
                  // Only close if user hasn't moved back to dropdown
            ...
            >
              ...
              {cartDropdownOpen && (
                <div 
                  ...
                  onMouseLeave={() => {
                    // Use a delay when leaving the dropdown too
                    setTimeout(() => {
                      setCartDropdownOpen(false);
                        ...
                        {cartItems.map((item) => (
                          <div key={item.id} className="flex p-3 gap-2">
                            ...
                            <div className="flex flex-col items-end justify-between">
                              <span className="text-pink-600 font-semibold text-sm">{(item.price * item.quantity).toLocaleString()}₫</span>
                            </div>
                          </div>
                        ))}
                      </div>
      ...
      <div className="bg-gradient-to-r from-pink-500 to-purple-700 w-full flex items-center px-6 py-3 text-white font-medium text-sm gap-6">
        ...
        <div className="relative group">
          ...
          <div className="hidden group-hover:grid grid-cols-3 gap-8 absolute top-full left-0 bg-white text-gray-700 py-4 px-6 shadow-lg rounded-b-lg w-[800px] z-20">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="#" className="hover:text-pink-500">Quà sinh nhật</a>
              <a href="#" className="hover:text-pink-500">Quà tặng cao cấp</a>
              <a href="#" className="hover:text-pink-500">Quà tặng Noel</a>

              <div className="font-bold mt-4">Đèn Trang Trí</div>
              <a href="#" className="hover:text-pink-500">Đèn bàn</a>
              <a href="#" className="hover:text-pink-500">Đèn ngủ</a>
            </div>

            {/* Cột 2 */}
            <div className="flex flex-col gap-2">
              <div className="font-bold">Hộp Mica</div>
              <a href="#" className="hover:text-pink-500">Hộp mica cao cấp</a>

              <div className="font-bold mt-4">Thú Bông</div>
              <a href="#" className="hover:text-pink-500">Gấu bông tình yêu</a>
              <a href="#" className="hover:text-pink-500">Mèo thần tài</a>

              <div className="font-bold mt-4">Gốm Sứ, Thủy Tinh</div>
              <a href="#" className="hover:text-pink-500">Bình giữ nhiệt</a>
            </div>

            {/* Cột 3 */}
            <div className="flex flex-col gap-2">
              <div className="font-bold">Hoa Khô</div>
              <a href="#" className="hover:text-pink-500">Hoa bó</a>
              <a href="#" className="hover:text-pink-500">Hoa trang trí</a>

              <div className="font-bold mt-4">Móc Khóa</div>
              <a href="#" className="hover:text-pink-500">Móc khóa quà tặng</a>

              <div className="font-bold mt-4">Văn Phòng Phẩm</div>
              <a href="#" className="hover:text-pink-500">Sổ tay</a>
              <a href="#" className="hover:text-pink-500">Bút ký cao cấp</a>
            </div>
          </div>
        </div>
        <a className="hover:text-purple-200" href="#">Dịch vụ gói quà</a>
        <a className="hover:text-purple-200" href="#">Kinh nghiệm</a>
        <a className="hover:text-purple-200" href="#">Cách chọn quà</a>
        <a className="hover:text-purple-200" href="#">Liên hệ</a>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          >
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-32 bg-white rounded shadow-lg z-50 py-2 text-gray-700"
                onMouseEnter={() => setIsDropdownOpen(true)}
                onMouseLeave={() => setIsDropdownOpen(false)}
              >
                <Link to="/login" className="block px-4 py-2 hover:bg-pink-50">Đăng nhập</Link>
                <Link to="/register" className="block px-4 py-2 hover:bg-pink-50">Đăng ký</Link>
              </div>
            )}
          </div>
        </div>
      ...
      <footer className="bg-gradient-to-r from-pink-500 to-purple-700 text-white py-8 px-4">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
            ...
            <p className="text-sm mb-2">Nơi tất cả mọi người đều có thể tìm kiếm và lựa chọn những món quà ý nghĩa.</p>
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><a href="#" className="hover:underline">Dịch vụ gói quà</a></li>
          ...
          <div>
            ...
            <p className="text-sm mb-2">Bạn có muốn nhận thông tin mới nhất từ chúng tôi?</p>
            <div className="flex mt-2">
              ...
              />
              <button className="bg-pink-500 px-3 py-1 rounded-r text-sm">GỬI</button>
            </div>
            <div className="flex gap-2 mt-4">
              <a href="#" className="bg-white text-pink-600 rounded-full w-8 h-8 flex items-center justify-center">f</a>
              <a href="#" className="bg-white text-pink-600 rounded-full w-8 h-8 flex items-center justify-center">in</a>
              <a href="#" className="bg-white text-pink-600 rounded-full w-8 h-8 flex items-center justify-center">p</a>
            </div>
          </div>
        </div>
