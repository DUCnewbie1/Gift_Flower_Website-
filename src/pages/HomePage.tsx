          ...
          <div className="flex flex-col">
            ...
            {product.basePrice && product.basePrice !== product.price && (
              <div className="flex items-center mt-1">
                <span className="text-gray-400 line-through text-xs">{product.basePrice.toLocaleString()}₫</span>
                <span className="bg-green-500 text-white text-[10px] px-1 rounded ml-1">Giá khu vực</span>
              </div>
            )}
                        ...
                        <div className="flex-1 p-3 flex flex-col justify-between">
                          ...
                          >
                            ...
                            <div className="flex items-center mt-2 justify-between">
                              <div className="flex flex-col">
                            <span className="text-pink-600 font-bold">{Math.round(product.price * (1 - parseInt(product.discount) / 100)).toLocaleString()}₫</span>
                              ...
                              <button 
                                ...
                                onClick={() => addToCart({
                                  ...
                                  price: (product.basePrice !== undefined && product.additionalPrice !== undefined)
                                    ...
                                    : product.price,
                                  originalPrice: product.discount !== "0%" ? Math.round(((product.basePrice !== undefined && product.additionalPrice !== undefined)
                                    ? product.basePrice + product.additionalPrice
                                    : product.price) * (1 - parseInt(product.discount) / 100)) : undefined,
                                  discount: product.discount !== "0%" ? product.discount : undefined,
                                  image: product.image || "/placeholder.png",
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 px-8">
                    ...
                    discountedProducts.slice(0, 5).map((product: any) => (
                      <div key={product._id} className="bg-white rounded-lg shadow-sm flex flex-col border border-gray-100 hover:shadow-md transition-shadow overflow-hidden relative p-2">
                        ...
                        <div className="flex items-center justify-between">
                        <div className="flex flex-col">
                        <span className="text-pink-600 font-bold text-sm">{Math.round(product.price * (1 - parseInt(product.discount) / 100)).toLocaleString()}₫</span>
                          {product.discount && product.discount !== "0%" && (  
                            <div className="flex items-center mt-1">
                              <span className="text-gray-400 line-through text-xs">
                                {product.price.toLocaleString()}₫
                        ...
                        <button 
                            ...
                            onClick={() => addToCart({
                              ...
                              image: product.image || "/placeholder.png",
                              regionalStock: product.regionalStock,
                              basePrice: product.basePrice, // Thêm basePrice
                              additionalPrice: product.additionalPrice, // Thêm additionalPrice
                              stockByStore: product.stockByStore, // Thêm stockByStore
                            })}
                          >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
