...
export default function HomePage() {
  ...
  const handleFavoriteToggle = (product: {
    ...
    if (isInFavorites(product._id)) { // Thay product.id thành product._id
      removeFromFavorites(product._id); // Thay product.id thành product._id
    } else {
      addToFavorites({
        _id: product._id, // Thay id thành _id
        name: product.name,
        price: product.price,
  ...
  const carouselImages = [
    {
      _id: "1", // Thay id thành _id và chuyển sang string
    ...
    {
      _id: "2", // Thay id thành _id và chuyển sang string
    ...
    {
      _id: "3", // Thay id thành _id và chuyển sang string
      ...
      <div className="max-w-7xl mx-auto flex flex-col px-6 py-6 gap-6 bg-white-50">
            ...
            {newProducts.length === 0 ? (
              ...
              <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1">
                {newProducts.map((item: any) => (
                  <Link to={`/detail/${item._id}`} key={item._id} className="flex gap-2 pb-3 border-b hover:bg-pink-50 transition p-2 rounded">
                    <img
        ...
        <div className="grid grid-cols-4 gap-3 mt-4">
          {["LOFI10", "LOFI15", "LOFI99K", "FREESHIP"].map((code) => (
            <div
              key={code}
              className="bg-gradient-to-r from-pink-500 to-purple-700 text-white rounded-lg p-3 flex flex-col items-center relative"
            >
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-5 gap-4">
            {[1, 2, 3, 4, 5].map((idx) => (
              <div
                key={idx}
                className="bg-white rounded-lg shadow-sm flex flex-col relative border border-gray-100 overflow-hidden"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={product._id}
                  className="bg-white rounded-lg shadow-sm flex border border-gray-100 overflow-hidden hover:shadow-md transition-shadow w-[350px]"
                >
                        ...
                        <div className="flex flex-col">
                          ...
                          {product.originalPrice && (
                            <div className="flex items-center mt-1">
                              ...
                              <span className="bg-pink-500 text-white text-xs px-1.5 py-0.5 rounded ml-2">
                                {product.discount}
                              </span>
                            </div>
                          )}
          ...
          <div className="bg-gradient-to-r from-pink-500 to-purple-700 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                ...
                <div
                  key={product._id}
                  className="bg-white rounded-lg shadow-sm flex flex-col border border-gray-100 hover:shadow-md transition-shadow overflow-hidden relative p-2"
                >
