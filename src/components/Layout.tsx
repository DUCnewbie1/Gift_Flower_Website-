        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <div
              ...
              onMouseLeave={() => setTimeout(() => setCartDropdownOpen(false), 300)}
            >
              <motion.button
                className="flex items-center gap-2 text-gray-800 hover:text-pink-600 transition"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div className="relative group">
              <button className="flex items-center gap-1 hover:text-purple-100 transition font-medium">
                Sản phẩm
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="hidden group-hover:grid grid-cols-3 gap-6 absolute top-full left-0 bg-white text-gray-800 py-6 px-8 shadow-xl rounded-b-xl w-[900px] z-20 border border-gray-100"
              >
                <div className="flex flex-col gap-3">
                  <div className="font-bold text-lg text-pink-600">Set Quà Tặng</div>
                  ...
                  <div className="font-bold text-lg mt-5 text-pink-600">Đèn Trang Trí</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Đèn bàn
                  </a>
                  <a href="#" className="hover:text-pink-600 transition">
                ...
                <div className="flex flex-col gap-3">
                  <div className="font-bold text-lg text-pink-600">Hộp Mica</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Hộp mica cao cấp
                  </a>
                  <div className="font-bold text-lg mt-5 text-pink-600">Thú Bông</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Gấu bông tình yêu
                  </a>
                  <a href="#" className="hover:text-pink-600 transition">
                  ...
                  <div className="font-bold text-lg mt-5 text-pink-600">Gốm Sứ, Thủy Tinh</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Bình giữ nhiệt
                  </a>
                </div>
                <div className="flex flex-col gap-3">
                  <div className="font-bold text-lg text-pink-600">Hoa Khô</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Hoa bó
                  </a>
                  <a href="#" className="hover:text-pink-600 transition">
                  ...
                  <div className="font-bold text-lg mt-5 text-pink-600">Móc Khóa</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Móc khóa quà tặng
                  </a>
                  <div className="font-bold text-lg mt-5 text-pink-600">Văn Phòng Phẩm</div>
                  <a href="#" className="hover:text-pink-600 transition">
                    Sổ tay
                  </a>
                  <a href="#" className="hover:text-pink-600 transition">
